...
class CompressNoEncryptionBench
{
    public $PATH = 'sessionforge_benchmark_test';
    public $FILE_NAME = 'compress-no-encryption';
    ...
    function benchCreate ()
    {
        try
        {
            $config = [ 'path' => $this->PATH, 'sessionId' => $this->FILE_NAME, 'hashKey' => $this->HASH_KEY, 'validUntil' => $this->TIME_OF_EXPIRE, 'compress' => true ];
